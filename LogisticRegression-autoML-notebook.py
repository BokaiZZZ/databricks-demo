...
# MAGIC This is an auto-generated notebook. To reproduce these results, attach this notebook to the **ML-Cluster** cluster and rerun it.
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/2469956737403832/s?orderByKey=metrics.%60val_f1_score%60&orderByAsc=false)
# MAGIC - Navigate to the parent notebook [here](#notebook/2469956737403822) (If you launched the AutoML experiment using the Experiments UI, this link isn't very useful.)
...
mlflow.set_experiment("/Users/bz87@duke.edu/databricks_automl/label_news_articles_csv-2022_03_18-11_59")
...
input_data_path = input_client.download_artifacts("258a40f270704d9f879fb10cd14e913b", "data", input_temp_dir)
...
X_train, split_X_rem, y_train, split_y_rem = train_test_split(split_X, split_y, train_size=0.6, random_state=233939951, stratify=split_y)

# Split remaining data equally for validation and test
X_val, X_test, y_val, y_test = train_test_split(split_X_rem, split_y_rem, test_size=0.5, random_state=233939951, stratify=split_y_rem)
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/2469956737403832/s?orderByKey=metrics.%60val_f1_score%60&orderByAsc=false)
...
sklr_classifier = LogisticRegression(
  C=0.054614190050371665,
  l1_ratio=0.5086035400883261,
  penalty="elasticnet",
  solver="saga",
  random_state=233939951,
