...
white_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/bz87@duke.edu/winequality_white.csv", sep=';')
red_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/bz87@duke.edu/winequality_red.csv", sep=';')
